  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="tables-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
        <li><a href="{{ route('users.index') }}"><i class="bi bi-table"></i><span>Data User</span></a></li>
        <li><a href="{{ route('admin.index') }}"><i class="bi bi-table"></i><span>Data Admin</span></a></li>
        <li><a href="{{ route('pelatih.index') }}"><i class="bi bi-table"></i><span>Data Pelatih</span></a></li>
        <li><a href="{{ route('siswa.index') }}"><i class="bi bi-table"></i><span>Data Siswa</span></a></li>
      </ul>
    </li><!-- End Tables Nav -->

    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#pembelajaran-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i>
          <span>Kelola Pembelajaran</span>
          <i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="pembelajaran-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          <li><a href="{{ route('kursus.index') }}"><i class="bi bi-table"></i><span>Kursus</span></a></li> <!-- Changed icon to 'bi-table' -->
      </ul>
  </li>
    <!-- End Pembelajaran Nav -->
